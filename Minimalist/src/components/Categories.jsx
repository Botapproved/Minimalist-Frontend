        ...
        {categories.map((category, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 border-2 border-grey hover:bg-slate-600 hover:bg-opacity-20 hover:text-black flex flex-col justify-end p-6">
              ...
              <button className="inline-flex items-center justify-center rounded-full bg-transparent border border-black text-black px-4 py-2 text-sm font-medium hover:bg-slate-500 hover:text-white transition-colors">
                Shop Now
